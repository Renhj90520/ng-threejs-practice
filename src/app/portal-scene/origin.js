const portalVertexShader =
  document.getElementById('portalVertexShader').textContent;
const portalFragmentShader = document.getElementById(
  'portalFragmentShader'
).textContent;

const firefliesVertexShader = document.getElementById(
