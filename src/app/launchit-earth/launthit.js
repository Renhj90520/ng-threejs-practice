...
function setupDeviceSettings() {
  ...
  if (deviceSettings.isAndroid || deviceSettings.isIEMobile)
    deviceSettings.isWebGL = false;
}
...
var mouse = new THREE.Vector2(),
  ...
  isGlobeEventsEnabled = false;

var globeRaycaster = new THREE.Raycaster(),
  intersects,
  intersection = null,
  isParticleHit = false,
  isMediaHit = false;
...
function createPreloader(callbackFn) {
  TweenMax.set('#bookNumber', {
    transformPerspective: 600,
    perspective: 300,
    transformStyle: 'preserve-3d'
  });
  TweenMax.set('#bookQuote', {
    transformPerspective: 600,
    perspective: 300,
    transformStyle: 'preserve-3d'
  });
  ...
  preloaderAnimationIn.fromTo(
    '#intro_book',
    2,
    { autoAlpha: 0 },
    { autoAlpha: 1, display: 'block', ease: Linear.easeNone },
    0
  );
  preloaderAnimationIn.fromTo(
    '#intro_book',
  ...
  preloaderAnimationIn.fromTo(
    ...
    2,
    { autoAlpha: 0 },
    { autoAlpha: 1, immediateRender: false, ease: Linear.easeNone },
    0.5
  );
  preloaderAnimationIn.fromTo(
    '#intro_book .cover, #intro_book .overlay',
    2,
    { rotationY: 0 },
    { rotationY: -40, immediateRender: false, ease: Expo.easeOut },
    0.5
  );
  preloaderAnimationIn.fromTo(
    '#intro_book .page1',
    2,
    { rotationY: 0 },
    { rotationY: -34, immediateRender: false, ease: Expo.easeOut },
    0.5
  );
  preloaderAnimationIn.fromTo(
    '#intro_book .page2',
    2,
    { rotationY: 0 },
    { rotationY: -27, immediateRender: false, ease: Expo.easeOut },
    0.5
  );
  preloaderAnimationIn.fromTo(
    '#intro_book .page3',
    2,
    { rotationY: 0 },
    { rotationY: -15, immediateRender: false, ease: Expo.easeOut },
    0.5
  );

  preloaderAnimationIn.to(
    '#intro_book .overlay',
    2,
  ...
  preloaderAnimationIn.to(
    '#intro_book .overlay',
    2,
    { rotationY: 0, immediateRender: false },
    2.5
  );
  preloaderAnimationIn.to(
    '#intro_book .cover',
  ...
  preloaderAnimationIn.fromTo(
    ...
    2,
    { autoAlpha: 1 },
    { autoAlpha: 0, immediateRender: false, ease: Linear.easeNone },
    2.5
  );
  preloaderAnimationIn.fromTo(
    '#intro_book',
    2,
    { scale: 1 },
    { scale: 0.8, immediateRender: false, ease: Power4.easeIn },
    2.5
  );

  preloaderAnimationIn.from(
    '#bookNumber',
    1,
    { z: generateRandomNumber(-200, -50), autoAlpha: 0, ease: Linear.easeNone },
    5
  );
  preloaderAnimationIn.fromTo(
    '#preloaderInner',
  ...
  preloaderAnimationIn.fromTo(
    '#preloaderBar',
    1,
    { scaleX: 0.5, autoAlpha: 0 },
    { scaleX: 1, autoAlpha: 1, ease: Expo.easeOut },
    7
  );
  ...
  TweenMax.staggerFromTo(
    '#bookNumber, #bookQuote div',
    3,
    { color: '#FFFFFF' },
    { color: '#FFFFFF', delay: 6 },
    0.1
  );
...
function startPreloader() {
  ...
  TweenMax.fromTo(
    ...
    { backgroundColor: '#33CCFF', ease: Linear.easeNone }
  );
  TweenMax.staggerTo(
    '#bookQuote div, #bookNumber',
    2,
    { color: '#33CCFF', immediateRender: false, ease: Linear.easeNone },
    0.1
  );
}
...
function initExperience() {
  ...
  document
    .getElementById('interactive')
    .addEventListener('mouseleave', onDocumentMouseLeave, false);
  ...
  document
    .getElementById('interactive')
    .addEventListener('touchend', onDocumentTouchEnd, false);
...
function playIntro() {
  ...
  introAnimation.fromTo(
    ...
    2,
    { x: 100, autoAlpha: 0 },
    { x: 0, autoAlpha: 1, ease: Expo.easeInOut },
    0.1,
    2
  );
  introAnimation.fromTo(
  ...
  minimapAnimation2.fromTo(
    minimapSpiral,
    1,
    { pixi: { alpha: 0 } },
    { pixi: { alpha: 1 }, ease: Linear.easeNone },
    0
  );
  minimapAnimation2.fromTo(
    minimapDetails,
  ...
  minimapAnimation2.fromTo(
    ...
    2,
    { pixi: { tint: 0xffffff } },
    { pixi: { tint: colorPrimary }, ease: Linear.easeNone },
    0
  );
  minimapAnimation2.fromTo(
    minimapMaskGradient,
    2,
    { pixi: { scaleX: 0 } },
    { pixi: { scaleX: 1.25 }, ease: Expo.easeOut },
    0
  );
  minimapAnimation2.fromTo(
    minimapSpiral,
    2,
    { pixi: { rotation: 90 } },
    { pixi: { rotation: 450 }, ease: Expo.easeOut },
    0
  );
  minimapAnimation2.fromTo(
    minimapSpiral,
    0.1,
    { pixi: { alpha: 0 } },
    { pixi: { alpha: 1 }, immediateRender: false, ease: Linear.easeNone },
    0
  );
  minimapAnimation2.fromTo(
    minimapSpiral,
    0.75,
    { pixi: { alpha: 1 } },
    { pixi: { alpha: 0 }, immediateRender: false, ease: Linear.easeNone },
    0.2
  );
  minimapAnimation2.fromTo(
    minimapMaskGradient,
    2,
    { pixi: { alpha: 1 } },
    { pixi: { alpha: 0 }, ease: Linear.easeNone },
    0.5
  );
  minimapAnimation2.fromTo(
    minimapBlipsGroup,
    0.65,
    { pixi: { scale: 0 } },
    { pixi: { scale: 1 }, ease: Expo.easeOut },
    0
  );
  minimapAnimation2.fromTo(
    minimapBlipArray,
  ...
  minimapAnimation2.fromTo(
    ...
    0.75,
    { pixi: { scaleY: 1 } },
    { pixi: { scaleY: 0 }, ease: Circ.easeInOut },
    0.1
  );
  minimapAnimation2.fromTo(
    minimapExtras1,
    3,
    { pixi: { rotation: 0 } },
    { pixi: { rotation: -360 }, ease: Expo.easeOut },
    0
  );
  minimapAnimation2.fromTo(
    minimapExtras1,
  ...
  minimapAnimation2.fromTo(
    ...
    1.5,
    { pixi: { scale: 0.5 } },
    { pixi: { scale: 1.1 }, ease: Expo.easeOut },
    0
  );
  minimapAnimation2.fromTo(
    minimapExtras2,
    0.1,
    { pixi: { alpha: 0 } },
    { pixi: { alpha: 0.5 }, ease: Linear.easeNone },
    0
  );
  minimapAnimation2.fromTo(
    minimapExtras2,
    1,
    { pixi: { alpha: 0.5, tint: 0xffffff } },
    {
      pixi: { alpha: 0, tint: colorPrimary },
      immediateRender: false,
      ease: Linear.easeNone
  ...
  descriptionAnimation.fromTo(
    ...
    {
      scrambleText: {
        text: 'ZOOM IN TO SEE LOCATIONS WITH PHOTOS',
        chars: '0123456789!@#$%^&*()'
      },
      ease: Expo.easeInOut
    },
  ...
  descriptionAnimation.fromTo(
    ...
    {
      scrambleText: {
        text: 'PLAY WITH THE OPTIONS BELOW',
        chars: '0123456789!@#$%^&*()'
      },
      ease: Expo.easeInOut
    },
...
function renderRings() {
  ringsObject.rotation.x = ringsObject.rotation.x +=
    (targetTiltX - ringsObject.rotation.x) * 0.25;
  ringsObject.rotation.z = ringsObject.rotation.z -=
    (targetTiltY + ringsObject.rotation.z) * 0.25;
}
...
function renderGlobe() {
  if (isGlobeEventsEnabled) {
    ...
    camera.position.z = camera.position.z +=
      (targetCameraZ - camera.position.z) * 0.01;
...
function createDots(callbackFn) {
  ...
  for (i = 0; i < dataMap.length; i++) {
    ...
    var dotPosition = latLongToVector3(
      x,
      y,
      globeRadius,
      globeExtraDistance + randomExtra
    );
  ...
  dotSpikesMesh = new THREE.LineSegments(
    dotSpikesBufferGeometry,
    dotSpikesMaterial
  );
...
function createMedia(callbackFn) {
  ...
  for (i = 0; i < dataMedia.length; i++) {
    ...
    var mediaPosition = latLongToVector3(
      x,
      y,
      globeRadius,
      globeExtraDistance + 8 + randomExtra
    );
...
function createArcsRocket(callbackFn) {
  ...
  for (i = 0; i < dataMap.length - 1; i++) {
    var p1 = latLongToVector3(
      dataMap[0][2],
      dataMap[0][3],
      globeRadius,
      globeExtraDistance
    );
    var p4 = latLongToVector3(
      dataMap[i + 1][2],
      dataMap[i + 1][3],
      globeRadius,
      globeExtraDistance
...
function renderRain() {
  ...
  for (var i = 0, i3 = 0; i < rainDetails.length; i++, i3 += 3) {
    ...
    if (pd.current.y > 0) {
      pd.alpha =
        (pd.current.y - rainBuffer) /
        (pd.origin.y - rainBuffer + rainFadeDistance);
    } else if (pd.current.y < 0) {
      pd.alpha =
        (pd.current.y + rainBuffer) /
        (pd.origin.y + rainBuffer - rainFadeDistance);
...
function checkHover() {
  ...
  if (intersects.length > 0) {
    ...
    if (!isParticleHit || tempCurrentLocationTitle != currentLocationTitle) {
      ...
      if (!TweenMax.isTweening(tempHoverTarget.scale)) {
        TweenMax.fromTo(
          tempHoverTarget.scale,
          1,
          { x: 2, y: 2 },
          { x: 10, y: 10, ease: Expo.easeOut }
        );
        TweenMax.fromTo(
          tempHoverTarget.material,
          1.5,
          { opacity: 1 },
          {
            opacity: 0,
  ...
  var intersection = intersects.length > 0 ? intersects[0] : null;
  if (intersects.length > 0) {
    var tempCurrentLocationTitle =
      '<b>' +
      dataMedia[intersection.index][0] +
      '</b> - ' +
      dataMedia[intersection.index][4];
    {
      currentLocationTitle = tempCurrentLocationTitle;
      if (!isMediaHit) isMediaHit = true;
      showTooltip();
    }
  } else {
    currentLocationTitle = '';
...
function checkClick() {
  ...
  if (intersects.length > 0) {
    ...
    tl.fromTo(
      ...
      {
        scrambleText: {
          text: dataMap[intersection.object.userData.id][4],
          chars: '0123456789!@#$%^&*()'
        },
        ease: Expo.easeInOut
      },
    ...
    tl.fromTo(
      ...
      { scrambleText: { text: ' ' } },
      {
        scrambleText: { text: bookDescription, chars: '0123456789!@#$%^&*()' },
        ease: Expo.easeInOut
      },
      0
    );
...
function changeTagline() {
  var taglineArray = [
    ...
    [
      '182',
      "If potential clients or the community don't see you or your work, then you don't exist."
    ],
    ...
    [
      '240',
      'Freelance or full-time, you are your own business and your time is valuable.'
    ],
    ['289', 'Plan vacations first. Worry about projects & deadlines second.'],
    [
      '07',
      'Dedication, passion and commitment are equally as important as artistic talent.'
    ],
    [
      '25',
      'Average is the opposite of great. Ordinary work will rarely achieve great attention.'
    ],
    [
      '221',
      'Sometimes you must be able to play the games and run with the wolves to move up the food chain.'
    ],
    [
      '222',
      'Job frustration can be a powerful motivator if you use it to your advantage.'
    ],
    [
      '284',
      "If you don't have a life or interests outside of work, you'll never have anything original to put into your work."
    ],
    ['19', 'Nothing changes if nothing changes.'],
    [
      '14',
      'Be prepared. Work hard. Love what you do. Finish every personal project.'
    ]
  ];
  ...
  $('#minimap')
    ...
    .mousemove(function(e) {
      if (isDragging) {
        ...
        var mapTargetRotationX =
          tempHeightPercentage * (maxVertDegrees * 2) - (maxVertDegrees + 15);
        var mapTargetRotationY =
          tempWidthPercentage * (maxHorizontalDegrees * 2);
        var baseRotationX =
          Math.round(rotationObject.rotation.x / radianLoop) * radianLoop;
        var baseRotationY =
          Math.round(rotationObject.rotation.y / radianLoop) * radianLoop;
        targetRotationX = baseRotationX + -mapTargetRotationX * toRAD;
        targetRotationY =
          baseRotationY - (mapTargetRotationY - maxHorizontalDegrees) * toRAD;
      }
    })
    ...
    $('.close').hover(
      function(e) {
        ...
        TweenMax.fromTo(
          '.close circle',
          0.5,
          { drawSVG: '50% 50%', stroke: colorSecondary },
          {
            drawSVG: '35% 65%',
            stroke: colorPrimary,
            display: 'block',
...
function setColors(type) {
  ...
  if (globeCreated) {
    ...
    var globeCloudColors = [];
    for (var i = 0; i < globeCloudVerticesArray.length; i++) {
      var tempPercentage = generateRandomNumber(85, 90) * 0.01;
  ...
  var cssStyle =
    ...
    tempRGB.b +
    ', .15);} ' +
    '.settings a.active { background-color: ' +
    colorPrimary +
    ';} ' +
...
var statNumber = 0;
function changeStat() {
  var statNumberArray = ['48', '36', '6'];
  var statDescriptionArray = ['COUNTRIES', 'U.S. STATES', 'CONTINENTS'];
  var tempStatLength = statNumberArray.length - 1;

  TweenMax.set('#nav-stats', { transformPerspective: 800 });

  var statAnimation = new TimelineMax({
    paused: true,
    force3D: true,
    repeat: -1,
    delay: 1,
...
function toggleInfo(target) {
  ...
  if (isInfoVisible) {
    ...
    tl.staggerTo(
      ...
      0.5,
      { drawSVG: '50% 50%', ease: Expo.easeInOut },
      0.25,
      0
    );
    tl.play(0);
    ...
    tl.staggerFromTo(
      ...
      2,
      { drawSVG: '50% 50%' },
      { drawSVG: '0 100%', ease: Expo.easeInOut },
      0.25,
      0
    );
    tl.fromTo(
...
function checkIsBlack(dataPixel) {
  if (
    dataPixel[0] == dataPixel[1] &&
    dataPixel[1] == dataPixel[2] &&
    dataPixel[2] === 0
  ) {
    return true;
  } else {
...
function createGlitch(callbackFn) {
  ...
  for (var i = 0; i < cometTotal; i++) {
    ...
    TweenMax.set('#pulseComet' + i, {
      rotation: i * cometRotation,
...
function generateExplosion() {
  ...
  explosionAnimation.fromTo(
    ringExplosionMesh.scale,
    1,
    { x: 1, y: 1 },
    { x: 3, y: 3, ease: Quint.easeOut },
    0
  );
  explosionAnimation.fromTo(
...
function generateGlitch() {
  ...
  if (minimapBgCreated) {
    ...
    minimapAnimation.fromTo(
      minimapLines,
      2,
      { pixi: { tint: 0xffffff } },
      { pixi: { tint: colorPrimary }, ease: Circ.easeOut },
      0
    );
    minimapAnimation.fromTo(
      minimapMaskGradient,
  ...
  TweenMax.fromTo(
    '#interactive',
    0.25,
    { x: generateRandomNumber(-10, 10), y: generateRandomNumber(-10, 10) },
    { x: 0, y: 0, ease: RoughEase.ease.config({ strength: 2, points: 20 }) }
  );
  ...
  glitcherAnimation.set(
    ...
    0
  ); //, autoAlpha: (generateRandomNumber(25,100)/100)
  glitcherAnimation.set(
    $('#glitcher .minibar'),
    {
      left: generateRandomNumber(0, 90) + '%',
  ...
  glitcherAnimation.set($('#glitcher .minibar'), { autoAlpha: 0 }, 0.35);
  //glitcherAnimation.set( "#glitcher .microtext", { autoAlpha: 0, display: "none", immediateRender: false }, 1);
  glitcherAnimation.set(
    '#glitcher',
    { autoAlpha: 0, display: 'none', immediateRender: false },
    1
  );
...
function onDocumentMouseMove(event) {
  ...
  if (isMouseDown) {
    ...
    targetRotationX =
      targetRotationXOnMouseDown + (mouseY - mouseYOnMouseDown) * 0.0025;
    targetRotationY =
      targetRotationYOnMouseDown + (mouseX - mouseXOnMouseDown) * 0.0025;
  }
  ...
  if (event.touches.length == 1) {
    ...
    if (isMouseDown) {
      ...
      if (targetCameraZ < globeMaxZoom + 50) {
        targetRotationX =
          targetRotationXOnMouseDown + (mouseY - mouseYOnMouseDown) * 0.001;
        targetRotationY =
          targetRotationYOnMouseDown + (mouseX - mouseXOnMouseDown) * 0.001;
      } else {
        targetRotationX =
          targetRotationXOnMouseDown + (mouseY - mouseYOnMouseDown) * 0.01;
        targetRotationY =
          targetRotationYOnMouseDown + (mouseX - mouseXOnMouseDown) * 0.01;
      }
    }
...
var dataMap = [
  ...
  [14, 0, 57.72, 12.03, 'G�teborg, Sweden'],
  ...
  [30, 0, 55.72, 12.51, 'S�borg, Denmark'],
  ...
  [35, 0, -23.57, -46.62, 'S�o Paulo, Brazil'],
  ...
  [83, 0, 24.8, -107.43, 'Culiac�n, Mexico'],
  ...
  [93, 0, 55.66, 12.54, 'K�benhavn, Denmark'],
  ...
  [109, 0, 51.5, -0.06, 'London, United Kingdom'],
  ...
  [117, 0, 51.44, -0.2, 'London, United Kingdom'],
  ...
  [214, 2, 51.6, 0.64, 'Hockley, United Kingdom'], //@dbfxstudio
  ...
  [256, 0, -23.55, -46.43, 'S�o Paulo, Brazil'],
  ...
  [299, 0, 47.39, 8.53, 'Z�rich, Switzerland'],
  ...
  [307, 0, -26.19, 28.0, 'Johannesburg, South Africa'],
  ...
  [339, 0, 47.37, 8.52, 'Z�rich, Switzerland'],
  ...
  [344, 0, 50.05, 19.95, 'Krak�w, Poland'],
  [345, 0, 41.06, -73.52, 'Stamford, CT, USA'],
  [346, 0, 52.2, 21.0, 'Warszawa, Poland'],
  ...
  [407, 0, 51.4, -0.26, 'New Malden, United Kingdom'],
  [408, 0, 41.87, -87.64, 'Chicago, IL, USA'],
  [409, 0, 41.0, 28.73, 'Istanbul, Turkey'],
  ...
  [417, 2, -35.2, 173.92, 'Kerikeri, New Zealand'], //@ericjordan
  // DELETED TEST ORDER
  ...
  [434, 0, 34.0, -118.45, 'Venice, CA, USA'],
  ...
  [454, 0, 49.1, 22.06, 'Pap�n, Slovakia'],
  [455, 0, 51.4, -0.77, 'Bracknell, United Kingdom'],
  ...
  [474, 0, 52.2963346, -0.25, 'Buckden, United Kingdom'],
  ...
  [483, 0, 51.59, 0.023, 'London, United Kingdom'],
  ...
  [497, 0, 44.84, -0.57, 'Bordeaux, France'],
  ...
  [600, 1, 50.79, -2.6, 'Dorset, United Kingdom'], //@mikebeecham
  // AMAZON UK FILLED
  ...
  [600, 1, 51.55, -0.2, 'London, United Kingdom'],
  [600, 1, 51.58, -0.2, 'London, United Kingdom'],
  [600, 1, 51.61, -0.2, 'London, United Kingdom'],
  [600, 1, 51.52, -0.2, 'London, United Kingdom'],
  [600, 1, 51.5, -0.04, 'London, United Kingdom'],
  ...
  [600, 1, 51.5, -0.042, 'London, United Kingdom'],
  ...
  [600, 1, 23.27, 113.18, 'Hong Kong, China'], //JeffLung
  [600, 1, 52.37, 4.82, 'Amsterdam, Netherlands'], //@harmenstruiksma
  [600, 1, 50.62, 5.52, 'Liege, Belgium'], //@luruke
  [600, 1, 51.93, 4.6, 'The Hague, Netherlands'], //@david_hoogland
  [600, 1, 59.33, 18.04, 'Stockholm, Sweden'], //@Alexhorre
  [600, 1, 52.38, 4.66, 'Haarlem, Netherlands'], //@jun_e_jay
  [600, 1, 54.34, 10.05, 'Kiel, Germany'], //@MAXIMILIAN_DAHL
  [600, 1, 53.55, 9.78, 'Hamburg, Germany'], //@SmiddyBurbon
  [600, 1, 12.95, 77.49, 'Bengaluru, India'], //@bchilakala - Kindle
  [600, 1, 48.85, 2.27, 'Paris, France'], //@vpierrev
  [600, 1, 41.39, 2.07, 'Barcelona, Spain'], //@bluemag
  [600, 1, 45.29, 19.85, 'Novi Sad, Serbia'], //@Bajazetov
  [600, 1, 12.95, 77.51, 'Bengaluru, India'], //@manpurwala
  [600, 1, 48.86, 2.27, 'Paris, France'], //bilalkhettab
  [600, 1, 6.55, 3.14, 'Lagos, Nigeria'], //@FlairMan_ - Kindle
  [600, 1, 49.87, 8.58, 'Darmstadt, Germany'], //@marekIsOkay
  [600, 1, 36.19, -5.92, 'Vejer De La Frontera, Spain'], //@m_stratto
  [600, 1, 45.46, 9.14, 'Milan, Italy'], //@maztheegg
  [600, 1, 46.3, 25.28, 'Odorheiu Secuies, Romania'], //@simotamas7
  ...
  // AMAZON - RANDOM INTERNATIONAL
  [600, 1, 19.7, -101.24, 'Morelia, Michoac�n, M�xico'], //@TheFrost084

  // AMAZON AUTHOR CENTRAL - USA - 194/359
  // NEED TO GET MOST RECENT 1000 BOOK LOCATIONS
  [600, 1, 38.66, -121.53, 'Sacramento, CA, USA'], //@HelloDuane
  [600, 0, 30.5, -97.85, 'Cedar Park, TX, USA'], //@figdigital - Kindle
  [600, 1, 35.66, -97.47, 'Edmond, OK, USA'], //@ryandavidk
  [600, 1, 35.15, -101.84, 'Amarillo, TX, USA'], //@stevebargas

  [600, 1, 34.0, -118.5, 'Santa Monica, CA, USA'], //@_micahcarroll
  ...
  [600, 1, 34.0, -118.15, 'Los Angeles, CA, USA'],
  [600, 1, 33.95, -118.1, 'Los Angeles, CA, USA'],
  [600, 1, 33.0, -117.97, 'Los Angeles, CA, USA'],
  [600, 1, 33.9, -118.05, 'Los Angeles, CA, USA'],
  [600, 1, 33.85, -118.0, 'Los Angeles, CA, USA'],
  ...
  [600, 1, 37.37, -122.0, 'Santa Clara, CA, USA'],
  ...
  // Boston, MA, USA
  // BOSTON, MA - 10
  [600, 1, 32.7, -117.05, 'San Diego, CA, USA'], //@SYLVIA38
  ...
  [600, 1, 40.0, -75.18, 'Philadelphia, PA, USA'],
  [600, 1, 40.0, -75.16, 'Philadelphia, PA, USA'],
  [600, 1, 40.0, -75.14, 'Philadelphia, PA, USA'],
  [600, 1, 40.0, -75.12, 'Philadelphia, PA, USA'],
  [600, 1, 40.0, -75.1, 'Philadelphia, PA, USA'],
  [600, 1, 40.0, -75.08, 'Philadelphia, PA, USA'],
  [600, 0, 38.87, -77.06, 'Washington, DC, USA'],
  [600, 0, 38.85, -77.04, 'Washington, DC, USA'],
  [600, 0, 38.83, -77.02, 'Washington, DC, USA'],
  [600, 0, 38.81, -77.0, 'Washington, DC, USA'],
  ...
  [600, 1, 28.39, -81.0, 'Orlando, FL, USA'],
  ...
  [600, 1, 35.53, -82.63, 'Asheville, NC, USA'], //@vpierrev
  ...
  [1014, 2, 45.5, -122.61, 'Portland, OR, USA'], // Jonathan Hooker
  ...
  [1018, 2, 33.6, -112.21, 'Peoria, AZ, USA'], // Lukas Ruebbelke
  [1019, 2, 33.5, -117.15, 'Temecula, CA, USA'] // Michael Harris
  // NATHAN ROBERTS
];
...
var dataMedia = [
  ...
  [
    ...
    26.03,
    -142.01,
    'Hawaiin Airlines, Pacific Ocean',
